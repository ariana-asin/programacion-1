...
int main()
{
    ...
    cin>>numero;
    int numero_aleatorio_1=(rand()%numero)+1;
    cout<<"los niños de 1 año son:"<< numero_aleatorio_1<<endl;
    int numero_aleatorio_2=(rand()%(numero-numero_aleatorio_1))+1;
    cout<<"los niños de 2 años son:"<< numero_aleatorio_2<<endl;
    int numero_aleatorio_3=(numero-numero_aleatorio_1-numero_aleatorio_2);
